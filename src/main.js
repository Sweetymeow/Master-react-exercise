...
var title_group =  [creatListItemFactory({className: 'title1', name: "Wendy 1. ", key: 'item-1' }), 
                    creatListItemFactory({className: 'title2', name: "Wendy 2. ", key: 'item-2' }),
                    creatListItemFactory({className: 'title3', name: "Wendy 3. ", key: 'item-3' })]; // 为什么className不起作用？
